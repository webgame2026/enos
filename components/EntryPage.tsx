...
const EntryPage: React.FC<EntryPageProps> = ({ onEnter }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center p-6 overflow-hidden bg-[#020617]">
      ...
      <div className="relative z-10 flex flex-col items-center space-y-8 text-center animate-in zoom-in-95 fade-in duration-1000">
        ...
        <div className="flex flex-col items-center gap-4 w-full">
          <div className="relative group">
            ...
            <Button 
              ...
              variant="primary" 
              size="lg" 
              className="relative px-16 py-10 text-4xl sm:text-5xl rounded-[3rem] shadow-[0_20px_40px_-10px_rgba(168,85,247,0.5)] transform hover:scale-105 active:scale-95 transition-all w-full sm:w-auto"
            >
              ENTER GAME
            </Button>
          </div>
          ...
          {isInstalled && (
             <div className="flex items-center gap-2 text-fuchsia-500/60 font-black uppercase tracking-widest text-[10px] animate-in fade-in duration-1000 pt-2">
               <CheckCircle2 size={12} /> App Installed & Synced
             </div>
          )}
        </div>

        <div className="flex gap-8 items-center opacity-30 pt-4">
